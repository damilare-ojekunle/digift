...
import frame from "../images/test1.png";
import frame2 from "../images/frame2.svg";
import gif from "../images/Gif.svg";
import icon from "../images/bg-icon.svg";
import Header from "../components/Header";
import insta from "../images/ins-socials.svg";
import fb from "../images/fa-socials.svg";
import linked from "../images/ins-socials.svg";
import twitter from "../images/ins-socials.svg";
    ...
    <div>
      ...
      <div className="bg-white min-h-screen">
        ...
        <section className="flex items-center justify-between my-32 mx-32 ">
          ...
          <div className="w-[47%] bg-bluish pt-8 pl-8 ">
            <img src="test1.png" />
            {/* <Image className="block" src={frame} width="600" height="426" /> */}
            {/* <div className=""></div> */}
          </div>
        </section>
        <section className="my-32 mx-16 ">
          <div className="flex flex-col items-center  space-y-10 bg-image bg-blue-500 rounded-md py-10 ">
