      ...
      <div className="bg-white min-h-screen">
        ...
        <header className=" bg-white shadow-md px-6 py-6 flex items-center justify-between ">
          ...
          <div className="flex items-center w-4/12 relative  outline-none ">
            <svg
              className="absolute ml-4 align-middle  "
              width="14"
              height="14"
              viewBox="0 0 14 14"
              fill="none"
            ...
            >
              <path
                d="M12.4538 12.998L9.72654 9.72532M11.1811 6.08896C11.1811 8.90059 8.90181 11.1799 6.09018 11.1799C3.27855 11.1799 0.999268 8.90059 0.999268 6.08896C0.999268 3.27732 3.27855 0.998047 6.09018 0.998047C8.90181 0.998047 11.1811 3.27732 11.1811 6.08896Z"
                stroke="#8A91A8"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
            ...
            <input
              className="w-full px-12 py-3 bg-lighterBlue rounded-md  "
          ...
          >
            ...
            />
            <path
              d="M27.4272 13.998H28.5701V16.8552H27.4272V13.998Z"
              fill="#8A91A8"
            />
            <path
              d="M31.2495 17.9415L33.2529 15.9375L34.0609 16.7461L32.0575 18.7495L31.2495 17.9415Z"
              fill="#8A91A8"
            />
            <path
              d="M33.1421 21.4258H35.9992V22.5686H33.1421V21.4258Z"
              fill="#8A91A8"
            />
            <path
              d="M31.2495 26.056L32.0575 25.248L34.0609 27.2515L33.2529 28.06L31.2495 26.056Z"
              fill="#8A91A8"
            />
            <path
              d="M27.4272 27.1406H28.5701V29.9978H27.4272V27.1406Z"
              fill="#8A91A8"
            />
            <path
              d="M21.939 27.2515L23.9424 25.248L24.7504 26.0566L22.747 28.06L21.939 27.2515Z"
              fill="#8A91A8"
            />
            <path
              d="M19.9995 21.4258H22.8567V22.5686H19.9995V21.4258Z"
              fill="#8A91A8"
            />
            <path
              d="M21.939 16.7461L22.747 15.9375L24.7504 17.9415L23.9424 18.7495L21.939 16.7461Z"
              fill="#8A91A8"
            />
            <path
              d="M26.5122 19.7717C26.9527 19.4774 27.4706 19.3203 28.0003 19.3203C28.7108 19.3203 29.3921 19.6025 29.8944 20.1048C30.3967 20.6072 30.6789 21.2885 30.6789 21.9989C30.6789 22.5287 30.5218 23.0465 30.2275 23.487C29.9332 23.9275 29.5148 24.2708 29.0254 24.4736C28.5359 24.6763 27.9974 24.7293 27.4778 24.626C26.9582 24.5226 26.4809 24.2675 26.1063 23.8929C25.7317 23.5183 25.4766 23.041 25.3732 22.5214C25.2699 22.0019 25.3229 21.4633 25.5257 20.9738C25.7284 20.4844 26.0717 20.0661 26.5122 19.7717Z"
              stroke="#8A91A8"
              stroke-width="1.5"
            />
            <path
              d="M73.2364 18.7816C73.2366 22.3993 76.2245 25.3058 79.8789 25.3062C80.5774 25.3072 81.2703 25.1995 81.933 24.9882C80.8231 26.9296 78.699 28.248 76.2528 28.248C72.6462 28.248 69.7493 25.3876 69.7493 21.8907C69.7493 19.2055 71.4564 16.8962 73.8834 15.968C73.458 16.8417 73.2353 17.8036 73.2364 18.7816ZM73.2364 18.7816C73.2364 18.7817 73.2364 18.7819 73.2364 18.782L73.9864 18.7812H73.2364C73.2364 18.7813 73.2364 18.7815 73.2364 18.7816Z"
              stroke="#8A91A8"
              stroke-width="1.5"
            />
          </svg>
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <path d="M0.999268 0.998047L0.999268 24.998" stroke="#F5F7FA" />
          </svg>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="flex items-center justify-between bg-[#005FDE] px-6 py-4 rounded-sm space-x-4">
              ...
              >
                <path
                  d="M3.3326 2.99805V5.66471M1.99927 4.33138H4.66593M3.99927 12.3314L3.99927 14.998M2.66593 13.6647H5.3326M8.66593 2.99805L10.1897 7.56948L13.9993 8.99805L10.1897 10.4266L8.66593 14.998L7.14212 10.4266L3.3326 8.99805L7.14212 7.56948L8.66593 2.99805Z"
                  stroke="white"
                  stroke-width="1.5"
                  stroke-linecap="round"
                  stroke-linejoin="round"
        ...
        <section className="flex items-center justify-between my-32 mx-32">
          <div className="w-[40%]  ">
            <div className="flex flex-col space-y-4 ">
              ...
              <h2 className="text-4xl max-w-sm">
                ...
                <span className="text-blue-500">the card</span> at a time!
              </h2>
          ...
          <div className="w-[47%] bg-bluish ">
            <div className="pt-8 pl-8">
              <Image className="" src={frame} width="600" height="426" />
            </div>
          </div>
        </section>
        <section className="my-32 mx-16 ">
          <div className="bg-blue-500 rounded-md py-10">ade</div>
        </section>
        <section className="my-32 mx-16 flex items-center justify-around  ">
          <div className="w-[45%] bg-bluish rounded-md py-10">a</div>
          <div className="w-[45%] bg-bluish rounded-md py-10 ">b</div>
        </section>
        <section className="flex items-center justify-between my-32 mx-32">
          <div className="w-[40%] ">
            <div className="flex flex-col space-y-4 ">
